...
export function colors(darkMode: boolean): Colors {
    return {
        ...
        // blue4: darkMode ? '#0000b8' : '#C4D9F8',
        // blue5: darkMode ? '#0000b8' : '#EBF4FF',
    }
}
...
body {
  ...
  background-image: ${({ theme }) =>
      `radial-gradient(50% 50% at 50% 50%, ${transparentize(0.9, '#0000b8')} 0%, ${transparentize(
          1,
          '#27b0e6'
      )} 100%)`};
  }
